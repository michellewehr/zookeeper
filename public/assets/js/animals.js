...
//If you study the code, however, you may find that we call the handleGetAnimalsSubmit() function on form submission. This function will gather all of the form input data and package it as an object to send to the getAnimals() function as the formData argument. From there, the object formData will be passed through the Object.entries() method to create query parameters. Because all that work is done for us, all we have to do is make the request using queryUrl
